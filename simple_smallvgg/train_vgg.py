...
from network.smallvggnet import SmallVGGNet
...
print("train x:",trainX.size)
print("train y:",trainY.size)

print("test x:",testX.size)
print("test y:",testY.size)
